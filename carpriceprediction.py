...
unique_ext= df['ext_col'].unique()
print("Unique transmissions:", unique_ext)

unique_int= df['int_col'].unique()
print("Unique transmissions:", unique_int)
...
# Assuming `xgb_reg` is your trained XGBoost model
with open('xgb_reg_model.pkl', 'wb') as file:
    pickle.dump(xgb_reg, file)

print("✅ XGBoost model saved as 'xgb_reg_model.pkl'")

xgb_reg.save_model("xgb_reg_model.json")
